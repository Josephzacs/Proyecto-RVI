...
IL_0053:
	{
		...
		L_15 = VirtualFuncInvoker0< TypeU5BU5D_t97234E1129B564EB38B8D85CAC2AD8B5B9522FFB* >::Invoke(117 /* System.Type[] System.Type::GetInterfaces() */, L_14);
		V_4 = L_15;
...
IL_00d5:
	{
		...
		NullCheck(L_42);
		Type_t* L_43;
		L_43 = VirtualFuncInvoker0< Type_t* >::Invoke(115 /* System.Type System.Type::get_BaseType() */, L_42);
		___0_type = L_43;
...
IL_0113:
	{
		...
		NullCheck(L_51);
		Type_t* L_52;
		L_52 = VirtualFuncInvoker0< Type_t* >::Invoke(115 /* System.Type System.Type::get_BaseType() */, L_51);
		___0_type = L_52;
